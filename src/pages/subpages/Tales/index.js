    ...
    <>
      <div className = "section-Tales">
        ...
        <div className="chart-wrapper">
          ...
          <div className="info-division">
            <p><b><a target="_blank" href="https://adventofcode.com/2021/day/3" className="link">[Day 3 - Binary Diagnostic]</a> </b></p>
      ...
      {/* <div className="chart-wrapper">
          <div className="info-division">
            <p><b><a target="_blank" href="https://adventofcode.com/2021/day/4" className="link">[Day 4 - Giant Squid]</a> </b></p>
          </div>
          <div className="chart-division">
          </div>
        </div> */}
